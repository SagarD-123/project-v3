...
app.post('/send-email', [verifyToken, upload.single('attachment')], async (req, res) => {
    const { to, cc, subject, text, emailPassword } = req.body;
    const attachment = req.file;

    console.log('Received request to send email:', { to, cc, subject, text, attachment, emailPassword });

    // Fetch user email from the database based on the username from the token
